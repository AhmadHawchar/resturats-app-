import 'package:apptest/pages/auth/owner/owner_home_page.dart';
        ...
        actions: [
          TextButton(
            onPressed: () {
              ...
              // TODO: Navigate to Owner Home Page
              Navigator.pushReplacement(
                  context, MaterialPageRoute(builder: (_) => OwnerHomePage()));
            },
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // Lottie Animation
                Lottie.asset(
                  'assets/splash.json', // Create a specific owner login animation
                  height: 250,
                  fit: BoxFit.contain,
                ),
